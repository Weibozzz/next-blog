...
import {
  Form, Button,
  Layout, Pagination, Input, Tabs, Table, Icon, message,
} from 'antd';
...
import {
  ALL, pageNum, ADMIN_TXT, COMMON_TITLE
...
class Admin extends Component {
  ...
  render() {
    ...
    const {
      adminBlogData = [], totalPageData = [], searchData = [],
      viewListData = {},
      getCommentsUserData: commentsUserData = [], getUserCommentsData = [],
      getCommentsData = [], ipListData = []
    } = this.props;
    // 昨日今日浏览记录
                ...
                ? (
                  <div>
                    ...
                    <Search
                      ...
                      onSearch={REQ_ACTION.onSearch.bind(this, this)}
                      enterButton="Search"
                      size="large"
                    />
                      ...
                      <Tabs defaultActiveKey="1" onChange={this.onTabChangeCallback.bind(this)}>
                        <TabPane tab="文章管理" key="1">
                          ...
                          <Pagination
                            ...
                            onChange={REQ_ACTION.onChange.bind(this, this)}
                          />
                        </TabPane>
...
const mapStateToProps = state => {
  const {
    ...
    postAdminPasswordData, getUserCommentsData,
    getCommentsData, ipListData, getCommentsUserData,
    viewListData
  } = state;
  return {
    adminBlogData,
