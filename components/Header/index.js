...
import {
  getSearchList, getSearchTotal, postAdminPassword, collectArticleList
} from '../../store/actions';
import MyHead from "../MyHead";
import './index.less';

const { MENU_RULE, pageNum } = ROUTER;
// toptis不需要seo
...
class TopNav extends Component {
  ...
  componentDidMount() {
    ...
    postAdminPassword(dispatch, postAdminPasswordUrl(), { password }).then(res => {
  ...
  onMyCollect(articleList) {
    ...
    const bool = articleList === 'articleList';
    const { dispatch } = this.props;
    !bool && this.setState({
      isAll: !isAll
    });
