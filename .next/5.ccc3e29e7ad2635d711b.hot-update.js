  ...
  _createClass(EditArticle, [{
    ...
    value: function onSubmit() {
      ...
      if (titleVal === '' || selectVal === '' || editCont === '') {
        __WEBPACK_IMPORTED_MODULE_3_antd_lib_message___default.a.error('必填项不能为空'); // return ;

      }

      Object(__WEBPACK_IMPORTED_MODULE_10__store_actions__["c" /* postArticle */])(dispatch, Object(__WEBPACK_IMPORTED_MODULE_9__config__["d" /* postArticleUrl */])(), queryParamsObj).then(function (res) {
        console.log(res);
      });
    }
  }, {
...
//# sourceMappingURL=5.ccc3e29e7ad2635d711b.hot-update.js.map