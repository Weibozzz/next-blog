...
function (_Component) {
  ...
  function Comments() {
    ...
    _this = _possibleConstructorReturn(this, (Comments.__proto__ || Object.getPrototypeOf(Comments)).call(this));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_Header__ = __webpack_require__("./components/Header/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_ArticleTitle__ = __webpack_require__("./components/ArticleTitle/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_PrevNextPage__ = __webpack_require__("./components/PrevNextPage/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_Comments__ = __webpack_require__("./components/Comments/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__config__ = __webpack_require__("./config/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__store_actions__ = __webpack_require__("./store/actions.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__config_constantsData__ = __webpack_require__("./config/constantsData.js");
...
function (_Component) {
      ...
      value: function value(e) {
        ...
        _this.props.form.validateFieldsAndScroll(function (err, values) {
          if (!err) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_22__store_actions__["d" /* postComments */])(dispatch, Object(__WEBPACK_IMPORTED_MODULE_21__config__["g" /* postCommentUrl */])(), queryStringComment);
          }
        });
      }
    });
  ...
  _createClass(Detail, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_11_react___default.a.createElement("div", {
      ...
      }, title, __WEBPACK_IMPORTED_MODULE_23__config_constantsData__["f" /* COMMON_TITLE */])), __WEBPACK_IMPORTED_MODULE_11_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_17__components_Header__["a" /* default */], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 125
        }
      ...
      }, __WEBPACK_IMPORTED_MODULE_11_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_18__components_ArticleTitle__["a" /* default */], {
        ...
        dangerouslySetInnerHTML: {
          __html: createTime > __WEBPACK_IMPORTED_MODULE_16__until__["a" /* OldTime */] ? marked(Object(__WEBPACK_IMPORTED_MODULE_16__until__["c" /* getHtml */])(decodeURIComponent(content), createTime), {
            breaks: true
          }) : Object(__WEBPACK_IMPORTED_MODULE_16__until__["c" /* getHtml */])(decodeURIComponent(content), createTime)
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 130
        }
      }), __WEBPACK_IMPORTED_MODULE_11_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_19__components_PrevNextPage__["a" /* default */], {
        dataSource: {
          url: url,
        ...
        return __WEBPACK_IMPORTED_MODULE_11_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_card___default.a, {
          ...
          }, Object(__WEBPACK_IMPORTED_MODULE_16__until__["b" /* formatTime */])(v.createTime)),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 213
          }
      ...
      })), __WEBPACK_IMPORTED_MODULE_11_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_20__components_Comments__["a" /* default */], {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return fetch(Object(__WEBPACK_IMPORTED_MODULE_21__config__["c" /* getDetailUrl */])(queryStrObj));

          case 4:
            blog = _context.sent;
            _context.next = 7;
            return fetch(Object(__WEBPACK_IMPORTED_MODULE_21__config__["b" /* getCommentsUrl */])(queryStrObj));

          case 7:
            comments = _context.sent;
            _context.next = 10;
            return fetch(Object(__WEBPACK_IMPORTED_MODULE_21__config__["d" /* getLastIdUrl */])(queryStrObj));

          case 10:
            lastId = _context.sent;
            _context.next = 13;
            return fetch(Object(__WEBPACK_IMPORTED_MODULE_21__config__["e" /* getNextIdUrl */])(queryStrObj));
...
//# sourceMappingURL=4.7097021e28a11a0f0f3e.hot-update.js.map