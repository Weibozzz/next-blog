...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__until__ = __webpack_require__("./until/index.js");
...
function (_Component) {
  ...
  _createClass(Admin, [{
    ...
    value: function componentWillMount() {
      ...
      var queryStringObj = {}; //getAdminBlogList(dispatch, getAdminBlogUrl(queryStringObj))
    }
  }, {
    key: "itemRender",
    ...
    value: function render() {
      ...
      var data = [].map(function (v, i) {
        return Object.assign({}, v, {
          key: i
        }, {
          createTime: Object(__WEBPACK_IMPORTED_MODULE_9__until__["b" /* formatTime */])(v.createTime)
        });
      });
...
//# sourceMappingURL=4.6e0eda0963a3eea698cd.hot-update.js.map